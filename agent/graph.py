...
from agent.tools import hybrid_search, list_versions, trace_impact, version_diff

load_dotenv()

TOOLS = [hybrid_search, trace_impact, version_diff, list_versions]

SYSTEM_PROMPT = (
    "You are a codebase assistant with four tools:\n"
